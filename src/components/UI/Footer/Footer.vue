<template>
  <footer
    class="footer text-center text-lg-start text-muted mt-3"
        ...
        <div class="row mt-3">
          ...
          <div class="col-6 col-sm-4 col-lg-3">
            ...
            <ul class="list-unstyled mb-4">
              <li>
                <a class="text-muted text-decoration-none" href="#">About us</a>
              </li>
              <li>
              ...
              <li>
                <a class="text-muted text-decoration-none" href="#">Blogs</a>
              </li>
            </ul>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-6 col-sm-4 col-lg-3">
            ...
            <ul class="list-unstyled mb-4">
              ...
              <li>
                <a class="text-muted text-decoration-none" href="#">Refunds</a>
              </li>
            </ul>
          </div>
          <!-- Grid column -->
